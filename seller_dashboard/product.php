        ...
        <div class="product-page">
          ...
          <div class="product-form" id="productForm" style="display: none;">
            ...
            <form action="product_operations.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="number" id="price" name="price" value="<?php echo $product['price'] ?? ''; ?>" step="0.01"
                min="0" required>

              <label for="stock_qty">Stock Quantity:</label>
              <input type="number" id="stock_qty" name="stock_qty" value="<?php echo $product['stock_qty'] ?? ''; ?>"
                min="0" required>
              ...
              <div class="product-file-upload">
                <input type="file" id="product_image" name="product_image" accept="image/*"
                  onchange="showImagePreview(event)" style="display: none;">
